// focus only on loginUser() function
...
// yha pe login user ko update krke cookies wala system add kr diya gya hai
        ...
        if(req.body.email){
            ...
            if(user){
                if(req.body.password==user.password){
                    res.cookie('login','1234',{httpOnly:true}); // [#1]
                    return res.json({
...
/*
1.
yha pe humne respone me cookie bheja hai
jiska naam hai - login 
aur value hai - 1234
httpOnly : true - isse sirf server ko hi access hoga cookies ka aur koi bnda ya brower cookies ko edit nhi kr skega
