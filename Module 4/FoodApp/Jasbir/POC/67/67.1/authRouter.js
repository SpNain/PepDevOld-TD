...
const bcrypt = require("bcrypt");  // required bcrypt here
...
async function loginUser(req, res) {
    try {
        ...
        if (user) {
            // kyunki humne password ko hashcode me convert kr diya tha 
            // to usko simple password = user.password se compare nhi kr skte 
            // uske liye hum bcrypt ka method use krte h compare naam ka
