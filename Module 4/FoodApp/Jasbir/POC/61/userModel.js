// focus only on role key in userSchema
...
const userSchema = new mongoose.Schema({
    ...
    token: String,
    validUpto: Date,
    // har ek user ka koi na koi role hoga
    // taki usko role ke hisab se alag alag access di jaa ske
    // role ka type string hoga
    // role enum me se hi ho skta hai
    // by default sbko user ka role assign ho jaayega 
    role: {
        type: String,
        enum: ["admin", "ce", "user"],
        default: "user"
